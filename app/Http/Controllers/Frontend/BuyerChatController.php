...
class BuyerChatController extends FrontendController
{
    public function chatShow()
    {
        ...
        $this->data('sellerData', Seller::all());
        return view("buyer.livechat", $this->data);
    }
    ...
    public function messageSend(Request $request)
    {
        ...
        $data['sender_username'] = Auth::guard('web')->user()->username;
