        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2><i class="fa fa-eye"></i> Blogs About &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                                <a href="{{route('admin-about.create')}}" class="btn-sm btn-success">
                                    <i class="fa fa-hand-o-right"></i> Create New About</a>
                            </h2>
                                        ...
                                        <table id="datatable" class="table table-striped table-bordered">
                                            ...
                                            @foreach($aboutData as $key=>$about)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($about->image)
                                                            <img src="{{url('uploads/about-us/'.$about->image)}}"
                                                                 alt="" width="40">
                                                        @endif
                                                    </td>
