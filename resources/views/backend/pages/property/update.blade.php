            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>
                                <i class="fa fa-edit"></i> Update Property</h2>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="types" id="types" class="form-control">
                                                        <option
                                                            value="rent" {{$property->types=='rent' ?'selected':''}}>
                                                            Rent
                                                        </option>
                                                        <option
                                                            value="sale" {{$property->types=='sale' ?'selected':''}}>
                                                            Sale
                                                        </option>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="is_slider" id="is_slider" class="form-control">
                                                        ...
                                                        <option value="1" {{$property->is_slider=='1'?'selected':''}}>
                                                            Yes
                                                        </option>
                                                    </select>
                                                </div>
