        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2><i class="fa fa-edit"></i> Update Service Type </h2>
                        ...
                        <div class="x_content">
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="{{route('admin-service-type.update',$serviceTypeData->id)}}"
                                          method="post">
                                        @csrf
                                        @method('PATCH')

                                        <div class="form-group">
                                            <label for="type">Title: <a href=""
                                        ...
                                        <div class="form-group">
                                            <button type="submit" class="btn-sm btn-success"><i
                                                    class="fa fa-newspaper-o"></i> Update Service Type
                                            </button>
                                        </div>
