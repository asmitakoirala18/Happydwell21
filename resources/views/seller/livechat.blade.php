                                ...
                                <div class="side-one">
                                    <div class="row heading">
                                        <div class="col-sm-3 col-xs-3 heading-avatar">
                                            <div class="heading-avatar-icon">
                                                <img
                                                    src="">
                                                <a href="">{{Auth::guard('seller')->user()->name}}</a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row sideBar">
                                        @foreach($buyerData as $buyer)
                                            <a href="javascript:void(0)" id="receiver_username"
                                            ...
                                            <span class="name-meta">{{$buyer->name}}
                                             </span>
                                                            </div>
                            ...
                            <div class="col-sm-8 conversation" style="display: none;">
                                ...
                                <div class="row reply">
                                    ...
                                    <div class="col-sm-9 reply-main">
                                        ...
                                        <form action="{{route('seller-send-message')}}" id="send_message_cline_all"
                                              method="post">
                                            {{csrf_field()}}
